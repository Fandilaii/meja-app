  ...
  return (
    <div className="p-6 flex items-center justify-center min-h-[60vh]">
      <div className="text-center max-w-sm">
        ...
        <h1 className="font-display font-bold text-ink text-2xl mb-2">Pengaturan</h1>
        <p className="text-sm font-sans text-ink/60 mb-1">Konfigurasi restoran dan akun</p>
